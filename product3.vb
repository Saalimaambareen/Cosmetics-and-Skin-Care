...
Public Class Form8
    ...
    End Sub
    Private Sub LoadSkin_products()
        ListBox1.Items.Clear()
        Using conn As New SqlConnection(connectionString)
            conn.Open()
            Dim cmd As New SqlCommand("SELECT ProductName FROM Skin_products", conn)
    ...
    Private Sub ListBox1_SelectedIndexChanged(sender As Object, e As EventArgs) Handles ListBox1.SelectedIndexChanged
        ...
        Using conn As New SqlConnection(connectionString)
            conn.Open()
            Dim cmd As New SqlCommand("SELECT * FROM Skin_products WHERE ProductName=@ProductName", conn)
