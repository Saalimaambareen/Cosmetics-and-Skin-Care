...
Public Class Form9
    ...
    End Sub
    Private Sub LoadPer_products()
        ListBox1.Items.Clear()
        Using conn As New SqlConnection(connectionString)
            conn.Open()
            Dim cmd As New SqlCommand("SELECT ProductName FROM Per_products", conn)
    ...
    Private Sub ListBox1_SelectedIndexChanged(sender As Object, e As EventArgs) Handles ListBox1.SelectedIndexChanged
        ...
        Using conn As New SqlConnection(connectionString)
            conn.Open()
            Dim cmd As New SqlCommand("SELECT * FROM Per_products WHERE ProductName=@ProductName", conn)
