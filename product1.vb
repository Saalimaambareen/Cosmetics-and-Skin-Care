...
Public Class Form6
    ...
    End Sub
    Private Sub LoadMake_products()
        ListBox1.Items.Clear()
        Using conn As New SqlConnection(connectionString)
            conn.Open()
            Dim cmd As New SqlCommand("SELECT ProductName FROM Make_products", conn)
    ...
    Private Sub ListBox1_SelectedIndexChanged(sender As Object, e As EventArgs) Handles ListBox1.SelectedIndexChanged
        ...
        Using conn As New SqlConnection(connectionString)
            conn.Open()
            Dim cmd As New SqlCommand("SELECT * FROM Make_products WHERE ProductName=@ProductName", conn)
